  ...
  return (
    <div className="space-y-5 max-w-3xl mx-auto">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-xl font-black text-zinc-900">Layanan Finishing</h1>
          <p className="text-sm text-zinc-500 mt-0.5">Kelola daftar layanan finishing — otomatis tersedia di Kalkulator Biaya Cetak</p>
        </div>
